...
- **Schema**: `RESULT` restricted to fixed vocabulary (`Rush`, `Penalty`, `KNEEL`, `Sack`, `Interception`, `Complete`, `Incomplete`, `TD`, `Def TD`, `Good`, `Safety`, `Block`, `Blocked`, `Batted Down`, `Dropped`, `Timeout`, `Offsetting Penalties`); per-game validation ranges (downs 0–4, `yardline_50` in [0, 50], monotonic drive IDs, gapless plays, score reconstruction) (C-07) (v1.2, 2026-09-03: sechs HC-Tokens ergänzt)
